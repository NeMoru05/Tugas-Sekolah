...
public class ObjectSpecialNPCProfessor extends Objects
{
    ...
    public void time4()
    {
        ...
        if(time[4] >= 0)
        {
            if(time[4] == 0 && DataPlayer.interactInput())
                time[5] = 60;
            else if(time[4] == 0)
                time[4]++;
            else if(time[4] % 75 == 0 && DataPlayer.interactInput())
                time[4]--;
            else if(time[4] % 75 == 0)
                time[4]++;
        }
            ...
            if(time[2] == 1 && DataPlayer.interactInput())
            {
                ...
                switch(DataPlayer.choice)
                {
                    case "Tepig" : DataPokemon.pokemonMoves1[0] = "Ember";
                        ...
                        DataPokemon.pokemonTypes1[0] = "Fire"; DataPokemon.pokemonTypes2[0] = null;
                        break;
                    case "Mudkip" : DataPokemon.pokemonMoves1[0] = "WaterGun";
                        DataPokemon.pokemonMoves2[0] = "Tackle";
                        DataPokemon.pokemonTypes1[0] = "Water"; DataPokemon.pokemonTypes2[0] = null;
                        break;
                    case "Turtwig" :  DataPokemon.pokemonMoves1[0] = "RazorLeaf";
                        DataPokemon.pokemonMoves2[0] = "Tackle";
                        DataPokemon.pokemonTypes1[0] = "Grass"; DataPokemon.pokemonTypes2[0] = null;
                        break;
                }
