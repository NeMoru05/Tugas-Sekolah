...
public class DataPlayer extends Datas
{
    ...
    * Puts the spawn coordinates of the player to the current world
    */
        ...
        if(currentWorld != null)
            switch(currentWorld)
            {
                ...
                case "WorldHousePlayerTrash" : WorldHousePlayerTownTrash.originalX = Player.worldX;
                    ...
                    break;
                case "WorldCaveStrange" : WorldCaveStrange.originalX = Player.worldX;
                    WorldCaveStrange.originalY = Player.worldY;
                    break;
            }
    }
}
