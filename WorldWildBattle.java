...
{
    static boolean attackOver;
    
    public WorldWildBattle(String type)
    {
        super(600, 500, 1);
        ...
        setBackground("BackBattleWild" + type + ".png");
        addStartObjects(type);
        addData();
        addOverlays();
        addMenuButtons();
    }
    ...
    public void addStartObjects(String type)
    {
        addObject(new BasePlayer(type), 204, 460);
        addObject(new BaseEnemy(type), 450, 68);
