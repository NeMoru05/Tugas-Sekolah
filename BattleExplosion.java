...
public class BattleExplosion extends Battle
{
    ...
    public void act()
    {
        ...
        if(time == 9)
        {
            ...
            int xpPercentage = DataPokemon.currentXP[DataPokemon.pokemonSelected] * 100 / DataPokemon.neededXP[DataPokemon.pokemonSelected];
            ...
            getWorld().addObject(new XPBar(), (470 + (xpPercentage * 2 - 200) / 2), 436);
